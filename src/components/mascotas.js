...
import { getMascotas, postMascotas, putMascotas, deleteMascotas } from "./callsMascotas";
...
export default function Mascotas() {
  ...
  useEffect(() => {
    getMascotas().then(response => {setMascotas(response.data)})
  }, [reload]);
      ...
      <div className="container-table">
        <table className="table border-primary ">
          ...
          {mascotas?.map((item, index) => (
            <tbody key={index}>
              <tr>
                <td> <b>{item.dataInput.name}</b></td>
                <td><b>{item.dataInput.edad}</b></td>
